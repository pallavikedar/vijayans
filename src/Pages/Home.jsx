      ...
      >
        ...
        <div className="why-choose-text">
          ...
          <p className="section-description">
            Yoga is more than just a workout; it’s a holistic practice that nurtures your body, mind, and soul. Whether you’re a beginner or an experienced practitioner, yoga offers countless benefits that can transform your life.
          </p>
          <ul className="why-choose-list">
            <li><span className="check-icon">✔</span> Yoga boosts brain power</li>
            <li><span className="check-icon">✔</span> Yoga improves flexibility and strength</li>
            <li><span className="check-icon">✔</span> Yoga helps alleviate stress and anxiety</li>
            <li><span className="check-icon">✔</span> Yoga promotes relaxation and well-being</li>
            <li><span className="check-icon">✔</span> Yoga improves self-confidence</li>
          </ul>
        </div>
      </motion.section>
